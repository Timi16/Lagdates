...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-sage-600 via-sage-500 to-coral-500 text-white">
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/auth/signup">
              <Button className="bg-white text-sage-600 hover:bg-white/90">Sign Up</Button>
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/auth/signup">
                <Button size="lg" className="bg-white text-sage-600 hover:bg-white/90">
                  Create Free Account
          ...
          <div className="md:w-1/2 relative">
            <div className="relative h-[500px] w-full max-w-md mx-auto">
                  ...
                  <div className="p-4">
                    <div className="relative h-[350px] rounded-xl overflow-hidden shadow-lg mb-4">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <h3 className="text-white text-xl font-bold">Emma, 21</h3>
                    ...
                    <div className="flex justify-between">
                      ...
                      <Button size="icon" className="h-12 w-12 rounded-full bg-coral-500 text-white">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -right-6 h-24 w-24 bg-coral-400 rounded-full opacity-50"></div>
              <div className="absolute -bottom-8 -left-8 h-32 w-32 bg-sage-400 rounded-full opacity-50"></div>
            </div>
          </div>
        </div>
      </header>
      ...
      {/* Features Section */}
      <section className="py-16 bg-gradient-to-b from-sage-50 to-white">
      ...
      {/* Premium Features */}
      <section className="py-16 bg-gradient-to-r from-sage-600 to-sage-500 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
      ...
      <section className="py-16 bg-gradient-to-r from-coral-600 to-coral-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/auth/signup">
              <Button size="lg" className="bg-white text-coral-600 hover:bg-white/90">
                Create Free Account
              </Button>
            </Link>
            <Link href="/auth/login">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-300">The premier dating app exclusively for university students.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-slate-300">support@lagdates.com</li>
                <li className="text-slate-300">1-800-LAG-DATE</li>
              </ul>
            </div>
          </div>
